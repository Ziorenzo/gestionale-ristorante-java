...
public class DebitCardReceipt extends Ricevuta {

    // Costruttore per la ricevuta con carta di debito
    public DebitCardReceipt(Integer id_ricevuta, String customer_id, Double total, Date date, String em_username,
    ...
    @Override
    public DebitCardReceipt clone() {
        try {
            return (DebitCardReceipt) super.clone();
